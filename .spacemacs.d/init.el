...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(sql
     ...
     (osx
      :variables osx-command-as       'hyper
          osx-option-as        'meta
   ...
   dotspacemacs-additional-packages '(;;clojure 
                                      kibit-helper)
